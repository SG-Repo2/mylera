...
BEGIN
  ...
  INSERT INTO public.user_profiles (id, display_name, device_type, measurement_system, show_profile)
  VALUES (NEW.id, display_name, device_type, measurement_system, show_profile)
  ON CONFLICT (id) DO UPDATE SET
    display_name = COALESCE(EXCLUDED.display_name, user_profiles.display_name),
    device_type = COALESCE(EXCLUDED.device_type, user_profiles.device_type),
    measurement_system = COALESCE(EXCLUDED.measurement_system, user_profiles.measurement_system),
...
CREATE POLICY "Users can insert their own metrics" ON "public"."daily_metric_scores" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can read their own metrics" ON "public"."daily_metric_scores" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update their own metrics" ON "public"."daily_metric_scores" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
GRANT SELECT ON TABLE "public"."daily_metric_scores" TO "anon";



GRANT ALL ON TABLE "public"."daily_totals" TO "authenticated";
GRANT SELECT ON TABLE "public"."daily_totals" TO "anon";



GRANT ALL ON TABLE "public"."daily_totals_with_rank" TO "authenticated";
GRANT SELECT ON TABLE "public"."daily_totals_with_rank" TO "anon";
...
GRANT SELECT ON TABLE "public"."weekly_totals" TO "anon";
