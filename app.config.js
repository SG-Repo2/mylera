    ...
    ios: {
      ...
      infoPlist: {
        NSHealthKitUsageDescription:
          'Mylera needs access to your health data to track fitness metrics and provide personalized insights.',
        NSHealthShareUsageDescription:
          'This app requires access to health data to track your fitness metrics.',
        NSHealthUpdateUsageDescription:
          'This app requires access to health data to track your fitness metrics.',
        NSPhotoLibraryUsageDescription:
          'Allow MyLera to access your photos to set a profile picture',
