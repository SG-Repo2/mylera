  ...
  switch (metricType) {
    case 'steps':
      ...
      tickValues = Array.from(
        { length: MIN_TICK_COUNT }, 
        (_, i) => Math.round(i * stepInterval)
      );
      break;
    ...
    case 'distance':
      ...
      tickValues = displayTicks.map(
        v => convertToInternalUnits(v, metricType, measurementSystem)
      );
      break;
